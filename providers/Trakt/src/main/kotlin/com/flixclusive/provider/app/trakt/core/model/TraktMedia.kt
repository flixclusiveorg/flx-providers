...
import com.flixclusive.provider.app.trakt.core.GenreUtil.toCatalog
...
internal data class TraktMedia(
    ...
    @JsonNames("released", "first_aired") val released: String? = null,
    @SerialName("subgenres") val subgenres: List<String>? = null,
